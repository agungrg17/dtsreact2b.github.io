...
const bacaData = (fnCallback) => {
  ...
  const bacaFile1 = (readFile1, fnCallback) => {
    fs.readFile(
      file1,
      'utf8',
      (err, data) => {
        if (err) {
          ...
          const hasil1 = JSON.parse(data);
            ...
            fnCallback(readFile1);
              }
        }
    )
  }
  
  const bacaFile2 = (readFile2, fnCallback) => {
    fs.readFile(
      file2,
      'utf8',
      (err, data) => {
        if (err) {
          ...
          const hasil2 = JSON.parse(data);
            ...
            fnCallback(readFile2);
        }
      }
    )
  }
  
  const bacaFile3 = (readFile3) => {
    fs.readFile(
      file3,
      'utf8',
      (err, data) => {
        if (err) {
          ...
          const hasil3 = JSON.parse(data);
            ...
            readFile3(null, hasilAkhir);
          }
        }
    )
  }

  bacaFile1(fnCallback, (readFile1) => {
    bacaFile2(readFile1, (readFile2) => {
      bacaFile3(readFile2);
    })
  });
};
